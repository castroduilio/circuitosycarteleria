...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-7674000.067518, -3890647.676598, -7654720.049587, -3881286.372328], maxZoom: 20, minZoom: 13
    })
});
...
map.getView().fit([-7674000.067518, -3890647.676598, -7654720.049587, -3881286.372328], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
        ...
        qgis2webAttribution.innerHTML = '<a href="https://github.com/tomchadwin/qgis2web">SYCSA</a> &middot; ';
        var olAttribution = document.createElement('li');
        olAttribution.innerHTML = '<a href="https://openlayers.org/">GC</a> &middot; ';
        var qgisAttribution = document.createElement('li');
        qgisAttribution.innerHTML = '<a href="https://qgis.org/">DC</a>';
